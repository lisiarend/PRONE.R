...
```{r}
plot_boxplot(se_norm, ain = c("Mean", "Median"), color_by = "Condition", label_by = NULL, facet_norm = TRUE)
```
...
```{r}
plot_boxplot(se_norm, ain = c("Mean", "Median"), color_by = "Condition", label_by = NULL, facet_norm = FALSE)
```
